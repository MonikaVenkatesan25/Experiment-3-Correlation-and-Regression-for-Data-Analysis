...
# Output
```
Enter x values (space separated): 54 64 74 84 94 04 24 34 14
Enter y values (space separated): 54 64 74 84 94 04 24 34 14
The Correlation coefficient is 1.000
The Regression line Y on X is :::
y = 49.556 + 1.000 (x - 49.556)
```
<img width="1920" height="1080" alt="graph" src="https://github.com/user-attachments/assets/746220ee-a701-4c16-9f63-cad935164694" />
